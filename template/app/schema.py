...
class Residential_lease_Drafting(Schema):
   city = fields.Str(default='')
   state = fields.Str(default='')
   date = fields.Str(default='')
   month = fields.Str(default='')
   year = fields.Str(default='')
   landlordName = fields.Str(default='')
   landlordAddress = fields.Str(default='')
   tenantName = fields.Str(default='')
   tenantAddress = fields.Str(default='')
   propertyAddress = fields.Str(default='')
   propertyType = fields.Str(default='')
   bedrooms = fields.Str(default='')
   bathrooms = fields.Str(default='')
   carparks = fields.Str(default='')
   squareFeet = fields.Str(default='')
   leaseTerm = fields.Str(default='')
   leaseStartDate = fields.Str(default='')
   noticePeriod = fields.Str(default='')
   rentAmount = fields.Str(default='')
   rentDueDate = fields.Str(default='')
   meterReading = fields.Str(default='')
   depositAmount = fields.Str(default='')
   lessorName = fields.Str(default='')
   lessorAddress1 = fields.Str(default='')
   lessorAddress2 = fields.Str(default='')
   lessorCityStatePin = fields.Str(default='')
   lesseeName = fields.Str(default='')
   lesseeAddress1 = fields.Str(default='')
   lesseeAddress2 = fields.Str(default='')
   lesseeCityStatePin = fields.Str(default='')     
